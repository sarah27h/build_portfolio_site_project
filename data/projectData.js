...
const  PROJRECTS = [
    ...
    },
    {
        ...
        info: 'The project is a projects manager users can sign up and create their own projects store them on the firebase.',
    ...
    },
    {
        ...
        info: 'The project requirements are to convert a static webpage to a mobile-ready web application. Webpage needed to take a static design that lacks accessibility and converts the design to be responsive on different sized displays and accessible for screen reader users. Succeeded in getting a score of 94% for accessibility and best practices after performing Audits test.',
    ...
    },
    {
        ...
        info: 'The project is part of the FEND Nanodegree, given a web-based application that reads RSS feeds.',
    ...
    },
    {
        ...
        info: 'Build a single-page web app using HTML, CSS, and JQuery convert starter code, including HTML and CSS to an interactive app, allow the user to create a grid of squares representing their design.',
