...
const  PROJRECTS = [
    {
        ...
        info: '● Built a simple project management tool with authentication and cloud functions. Users can sign up, create their own projects and store them on the firebase. ●  Succeeded in getting a score of 92% for accessibility, 86% for best practices, and 68% for performance after performing Audits test.',
    ...
    },
    {
        ...
        info: '● Built a single page application from scratch to work as an interactive, responsive weather app. ● Succeeded in getting a score of 100% for accessibility, 93% for best practices and 71% for performance after performing Audits test.',
    ...
    },
    {
        ...
        info: '● Programmed a static HTML & CSS starter project using JS, HTML, CSS to make 100% an interactive and responsive game with a timer, modal box showing game score. ● Succeeded in getting a score of 83% for accessibility and 88% for best practices after performing Audits test.',
    ...
    },
    {
        ...
        info: '● Used Jasmine 2.2 to test code against a pre-existing reads RSS feeds application to quickly test whether new code breaks an existing feature within my code, without having to manually test all of the functionality.',
    ...
    },
    {
        ...
        info: '● Built from scratch a responsive  HTML template. Created to fit a small business like cake shops, patisserie shops, and bakeries. ● Succeeded in getting a score of 75% for accessibility, 65% for both best practices and performance after performing Audits test.',
    ...
    },
    {
        ...
        info: '● Built an interactive app using HTML, CSS, and JQuery, allow the user to create a grid of colored squares representing their design.',
